            ...
            <section class="mb-14">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="bg-white rounded-xl p-6 border border-slate-200 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all duration-300">
                        ...
                        <p class="text-sm text-slate-600 leading-relaxed break-keep">
                            재직 중 조직이 83명에서 240명 이상으로 성장하는 동안 규정과 프로세스를 정비하고 근로감독 대응을 단독 수행해 법적 이슈 0건 유지
                        </p>
                    </div>
            ...
            <section>
                ...
                <div class="timeline-container">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="mt-5 space-y-4 text-[15px] text-slate-700 bg-slate-50 p-5 rounded-xl border border-slate-100">
                            <div>
                                <strong class="text-slate-900 flex items-center mb-1"><i class="fas fa-check text-blue-500 mr-2 text-xs"></i>채용</strong>
                                <p class="text-slate-600 ml-5 break-keep">2023년 입사자 94명 전원 채용, ATS 도입, 채용 홈페이지 제작</p>
                            </div>
                            <div>
                                <strong class="text-slate-900 flex items-center mb-1"><i class="fas fa-check text-blue-500 mr-2 text-xs"></i>HRM · 노무</strong>
                                <p class="text-slate-600 ml-5 break-keep">근로감독 대응(법적 이슈 0건), 인사 규정 기획, 근태/연차 관리</p>
                            </div>
                            <div>
                                <strong class="text-slate-900 flex items-center mb-1"><i class="fas fa-check text-blue-500 mr-2 text-xs"></i>Payroll</strong>
                                <p class="text-slate-600 ml-5 break-keep">급여 검증 및 마감, 퇴직연금 관리, 연말정산</p>
                            </div>
                            <div>
                                <strong class="text-slate-900 flex items-center mb-1"><i class="fas fa-check text-blue-500 mr-2 text-xs"></i>평가 · 보상</strong>
                                <p class="text-slate-600 ml-5 break-keep">급여 테이블 설계, 분기별 평가 체계 신설(레몬베이스 도입)</p>
                            </div>
                            <div>
                                <strong class="text-slate-900 flex items-center mb-1"><i class="fas fa-check text-blue-500 mr-2 text-xs"></i>조직문화</strong>
                                <p class="text-slate-600 ml-5 break-keep">100~200명 규모 사내 행사 주도, 복지 제도 제안</p>
                            </div>
                            <div>
                                <strong class="text-slate-900 flex items-center mb-1"><i class="fas fa-check text-blue-500 mr-2 text-xs"></i>HR 제도 개선</strong>
                                <p class="text-slate-600 ml-5 break-keep">근태툴 전환(비용 절감), ERP 및 ATS 도입</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="mt-3 text-[15px] text-slate-600 pl-2">
                            <ul class="list-disc list-outside ml-4 space-y-1 break-keep">
                                <li>그리팅 기반 채용 전 과정 수행 및 사내 문화행사 지원</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="mt-3 text-[15px] text-slate-600 pl-2">
                            <ul class="list-disc list-outside ml-4 space-y-1 break-keep">
                                <li>파견/정규직 채용, 다이렉트 소싱, 도급처 운영</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="mt-3 text-[15px] text-slate-600 pl-2">
                            <ul class="list-disc list-outside ml-4 space-y-1 break-keep">
                                <li>크루 채용, 근태/급여/복리후생 관리, 인건비 예산 집계</li>
                            </ul>
                        </div>
                    </div>
